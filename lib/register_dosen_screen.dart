...
import 'package:flutter_application_2/login_dosen_screen.dart';
import 'package:flutter_application_2/styles.dart';
import 'package:flutter_application_2/widget/custom_textfield.dart';

class RegisterDosenScreen extends StatelessWidget {
  const RegisterDosenScreen({Key? key}) : super(key: key);
              ...
              TextButton(
                onPressed: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => LoginDosenScreen(),
                    ),
                  );
                },
                child: Text(
